...
```
▶️ Como executar
Instale o Python 3.12 ou uma versão compatível.
Instale as dependências:
```bash
pip install pandas matplotlib seaborn jupyter
```
Coloque `main.ipynb` e `players_data_light-2024_2025.csv` na mesma pasta.
...
```
▶️ How to run
Install Python 3.12 or a compatible version.
Install the required dependencies:
```bash
pip install pandas matplotlib seaborn jupyter
```
Place `main.ipynb` and `players_data_light-2024_2025.csv` in the same directory.
